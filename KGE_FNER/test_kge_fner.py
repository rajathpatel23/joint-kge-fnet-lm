...
from src.model.nn_model_kge_fner import NAM_Modified
...
if __name__ == "__main__":
    ...
    if not os.path.exists(DATA_LOCATION + "run_log_fner_kge/"):
        os.makedirs(DATA_LOCATION + "run_log_fner_kge/")
    Log_location = DATA_LOCATION + "run_log_fner_kge/"
    if not os.path.exists(DATA_LOCATION + "model_fner_kge/"):
        os.makedirs(DATA_LOCATION + "model_fner_kge/")
    sess_save_location = DATA_LOCATION + 'model_fner_kge/'
    ...
    train_dataset = joblib.load(DATA_LOCATION_2 + "train_dataset" + "_11072019.pkl")
    dev_dataset = joblib.load(DATA_LOCATION_2 + "dev_dataset" + "_11072019.pkl")
    test_dataset = joblib.load(DATA_LOCATION_2 + "test_dataset" + "_11072019.pkl")
    ...
    Model = NAM_Modified(embedding_matrix_fner=dicts['id2vec'], lstm_layer=lstm_size, balance=args.balance,
    ...
    joblib.dump(type_embed,  DATA_LOCATION + "run_log_fner_kge/" + model_name + "type_embed.pkl")
