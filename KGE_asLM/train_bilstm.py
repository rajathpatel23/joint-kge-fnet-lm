...
if __name__ == '__main__':
    ...
    parser.add_argument('--splits', help="BiLSTM embedding split", default=9, type=int)
    args = parser.parse_args()
    if not os.path.exists(args.data_location + "run_logs_bilstm/"):
        os.makedirs(args.data_location + "run_logs_bilstm/")
    Log_location = args.data_location + "run_logs_bilstm/"
    if not os.path.exists(args.data_location + "model_BiLSTM/"):
        os.makedirs(args.data_location + "model_BiLSTM/")
    sess_save_location = args.data_location + "model_BiLSTM/"
    ...
    Model = NAM_Modified(embedding_matrix, lstm_layer=args.lstm_size, balance=args.weight, hidden_units_1=1024,
                         hidden_units_2=512, hidden_units_3=512, hidden_units_4=1, dropout=args.keep_prob,
